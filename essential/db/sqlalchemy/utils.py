...
from essential import context as request_context
from essential.db.sqlalchemy import models
from essential.gettextutils import _, _LI, _LW
...
def drop_unique_constraint(migrate_engine, table_name, uc_name, *columns,
    ...
    essential.db in a few releases. Please use UniqueConstraint.drop()
    method directly for sqlalchemy-migrate migration scripts.
