...
from essential import versionutils
...
The current message format (version 2.0) is very simple.  It is::
    ...
    {
        'essential.version': <RPC Envelope Version as a String>,
        'essential.message': <Application Message Payload, JSON encoded>
    }
...
_VERSION_KEY = 'essential.version'
_MESSAGE_KEY = 'essential.message'
