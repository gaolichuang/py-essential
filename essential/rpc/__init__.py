...
def create_connection(new=True):
    ...
    :returns: An instance of essential.rpc.common.Connection
    """
...
def call(context, topic, msg, timeout=None):
    ...
    :param topic: The topic to send the rpc message to.  This correlates to the
                  topic argument of
                  essential.rpc.common.Connection.create_consumer()
    ...
    :raises: essential.rpc.common.Timeout if a complete response
