...
:mod:`essential.report.models.threading`.
"""
...
import essential.report.models.threading as tm
from essential.report.models import with_default_views as mwdv
import essential.report.utils as rutils
import essential.report.views.text.generic as text_views
...
class ThreadReportGenerator(object):
    ...
    :class:`essential.report.models.threading.ThreadModel`
...
class GreenThreadReportGenerator(object):
    ...
    This generator returns a collection of
    :class:`essential.report.models.threading.GreenThreadModel`
    ...
    .. seealso::
        ...
        Function :func:`essential.report.utils._find_objects`
    """
