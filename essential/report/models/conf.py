...
model for :mod:`essential.config` configuration options
"""

import essential.report.models.with_default_views as mwdv
import essential.report.views.text.generic as generic_text_views
...
class ConfigModel(mwdv.ModelWithDefaultViews):
    ...
    from :mod:`essential.config`.  It supports both the default group
    of options and named option groups.

    :param conf_obj: a configuration object
    :type conf_obj: :class:`essential.config.cfg.ConfigOpts`
    """
