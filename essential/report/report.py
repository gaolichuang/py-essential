...
import essential.report.views.text.header as header_views
...
class BasicReport(object):
    ...
    def add_section(self, view, generator, index=None):
        ...
        returns a :class:`essential.report.models.base.ReportModel`
        or similar object.
...
class ReportOfType(BasicReport):
    ...
    .. seealso::
       ...
       Class :class:`essential.report.models.with_default_view.ModelWithDefaultView` # noqa
          (the entire class)

       Class :class:`essential.report.models.base.ReportModel`
           :func:`essential.report.models.base.ReportModel.set_current_view_type` # noqa
...
class TextReport(ReportOfType):
    ...
    def add_section(self, heading, generator, index=None):
        ...
        :class:`essential.report.views.text.header.TitledView`
