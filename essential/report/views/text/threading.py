...
import essential.report.views.jinja_view as jv
...
class StackTraceView(jv.JinjaView):
    ...
    :class:`essential.report.models.threading.StackTraceModel`
    """
...
class GreenThreadView(object):
    ...
    model :class:`essential.report.models.threading.GreenThreadModel`  # noqa
    """
...
class ThreadView(object):
    ...
    model :class:`essential.report.models.threading.ThreadModel`  # noqa
    """
